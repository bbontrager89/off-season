...
SwerveDriveWheel::SwerveDriveWheel(double P, double I, double D, rev::CANSparkMax *directionMotor, rev::CANSparkMax *speedMotor) : directionMotor(directionMotor), speedMotor(speedMotor), directionEncoder(directionMotor->GetEncoder())
{
